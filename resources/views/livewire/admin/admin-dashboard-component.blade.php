    ...
    <div class="container-fluid">
        <div class="row">
            <div class="form-group">
                <label for=""></label>
                <select class="form-control form-control-sm" name="" id="" wire:model ="Select_time">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>New Order</h5>
                        <h2><span class="counter">{{$count_orders}}</span> Orders</h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Total Income</h5>
                        <h2><u>đ</u><span class="counter">{{number_format($sum_orders)}}</span> </h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Total Expense</h5>
                        <h2><u>đ</u><span class="counter">200,000,000</span> </h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>New User</h5>
                        <h2>$<span class="counter">{{$count_users}}</span> User</h2>
